...
| [T11.1.1](items/T11.1.1.md) | 生成プロンプト構築・実行・複数バリアント対応 | Must | M | Done | T1.2.3, T3.2.3, T10.1.1, T8.1.1 |
| [T12.1.1](items/T12.1.1.md) | 評価プロンプト構築・スコア算出・合格判定 | Must | M | Done | T1.2.3, T3.1.1, T10.1.1, T11.1.1 |
| [T13.1.1](items/T13.1.1.md) | ビルドフェーズオーケストレーション（Step 0-5） | Must | M | Done | T4.1.1〜T9.1.2 |
| [T13.1.2](items/T13.1.2.md) | ジェネレートフェーズオーケストレーション（Step 6-8） | Must | M | Done | T10.1.1〜T12.1.1 |
...
| [T14.1.2](items/T14.1.2.md) | build・stepコマンド | Must | M | Done | T14.1.1, T13.1.1, T13.2.2 |
| [T14.1.3](items/T14.1.3.md) | generateコマンド | Must | M | Done | T14.1.1, T13.1.2 |
| [T14.1.4](items/T14.1.4.md) | inspect・cost・cleanコマンド・UX | Must | M | Done | T14.1.1, T13.2.1 |
| [T15.1.1](items/T15.1.1.md) | Vite + React + Zustand + Tailwindセットアップ | Should | M | Done | T1.1.1 |
| [T15.1.2](items/T15.1.2.md) | Web Worker (kuromoji.js + Transformers.js) | Should | M | Done | T15.1.1, T5.1.1, T9.1.1 |
| [T15.1.3](items/T15.1.3.md) | IndexedDBストレージ・データ永続化 | Should | M | Done | T15.1.1 |
| [T15.2.1](items/T15.2.1.md) | APIキー入力・CORS警告・同意ダイアログ | Should | M | Done | T15.1.1 |
| [T15.2.2](items/T15.2.2.md) | ファイルアップロード・ビルド実行・進捗表示 | Should | M | Done | T15.1.2, T15.1.3, T15.2.1, T13.2.2 |
| [T15.2.3](items/T15.2.3.md) | ペルソナ閲覧・ビジュアライズ | Should | M | Done | T15.1.3, T15.2.2 |
| [T15.2.4](items/T15.2.4.md) | テキスト生成・評価結果表示 | Should | M | Done | T15.2.2, T13.1.2 |
...
| [T16.1.2](items/T16.1.2.md) | ローカル処理パッケージのユニットテスト | Must | M | Done | T16.1.1, T4.1.1, T5.1.3, T10.1.1 |
| [T16.1.3](items/T16.1.3.md) | LLM利用パッケージのモック・スナップショットテスト | Must | M | Done | T16.1.1, T6.1.2〜T12.1.1 |
